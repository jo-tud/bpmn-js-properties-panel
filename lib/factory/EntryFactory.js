...
var textInputField = require('./TextInputEntryFactory'),
    ...
    referenceSelectBoxField = require('./SelectReferenceEntryFactory');
...
EntryFactory.referenceSelectBox = function(options) {
  return referenceSelectBoxField(options, setDefaultParameters(options), getRoot, findRootElementsByType,
    removeAllChildren);
};
